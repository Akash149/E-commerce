function  add_to_cart(pid, pname, pprice) {
    ...
    if (cart === null) {
        ...
        let product = {productId: pid, productName: pname,
            productQuantity: 1, productPrice: pprice};
        ...
        cart.map((item) => {
            table += `
                        <tr>
                            ...
                            <td> <button onclick='deleteItemFromCart(${item.productId})' 
                            class='btn btn-danger btn-sm'><i class="fa-solid fa-trash-can"></i></td>
